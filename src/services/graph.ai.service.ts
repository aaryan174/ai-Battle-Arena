import { StateSchema, StateGraph, type GraphNode, type CompiledStateGraph, START, END  } from "@langchain/langgraph";
import { z } from "zod"
import {mistralModel, geminiModel, choreModel} from "../services/model.service.js"
...
const solutionNode: GraphNode<typeof state> = async (state) => {
    ...
    const [mistralResponse, cohereResponse] = await Promise.all([
        ...
        choreModel.invoke(state.problem)
    ])
